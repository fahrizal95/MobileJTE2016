...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickButton (View view){
        final TextView A = (TextView) findViewById(R.id.angka1);
        final TextView B = (TextView) findViewById(R.id.angka2);
        Button Atas = (Button) findViewById(R.id.ateh);
        Button Bawah = (Button) findViewById(R.id.diyup);
        Button Kiri = (Button) findViewById(R.id.wie);
        Button Kanan = (Button) findViewById(R.id.neun);
