...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickBtnLogin (View view){
        ...
        EditText numInputAngka = (EditText) findViewById(R.id.editText);
        String numInputAngkaStr = numInputAngka.getText().toString();
        int pinInt = Integer.valueOf(numInputAngkaStr);
