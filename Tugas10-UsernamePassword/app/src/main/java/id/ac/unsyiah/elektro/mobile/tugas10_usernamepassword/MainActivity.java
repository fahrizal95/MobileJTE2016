...
public class MainActivity extends AppCompatActivity {
    ...
    public void onMasuk (View view){
        ...
        String userPref = sharedPreferences.getString("username", "fahrizal");
        String passPref = sharedPreferences.getString("password", "1234");
        ...
        if(username.equals(userPref)){
            if(password.equals(passPref)) {
                ...
                Toast toast = Toast.makeText(this, "Password Yang Anda Masukkan Salah ! ", Toast.LENGTH_SHORT);
                toast.setGravity(Gravity.CENTER, 0, 0);
                toast.show();
            }

        }else{
            Toast toast = Toast.makeText(this, "Username Yang Anda Masukkan Tidak Ada ! ", Toast.LENGTH_SHORT);
            toast.setGravity(Gravity.CENTER, 0, 0);
            toast.show();
        }
    }
