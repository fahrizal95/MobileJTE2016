...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickTerjemahkanInggris(View view) {
        TextView txtTxt = (TextView) findViewById(R.id.Txt);
        String Inggris = getString(R.string.TxtEnglish);
        txtTxt.setText(Inggris); }

    public void onClickTerjemahkanIndonesia(View view) {
        TextView txtTxt =   (TextView) findViewById(R.id.Txt);
        String Indo = getString(R.string.TxtIndonesia);
        txtTxt.setText(Indo); }

    public void onClickTerjemahkanAceh(View view) {
        TextView txtTxt =   (TextView) findViewById(R.id.Txt);
        String Aceh = getString(R.string.TxtAceh);
        txtTxt.setText(Aceh); }
}
